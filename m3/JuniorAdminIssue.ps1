...
$vpc = Get-EC2Vpc -Filter @{Name="tag:Name"; Values="toolchain-primary"}
...
$publicRouteTable = Get-EC2RouteTable `
     -Filter @{ Name="tag:Name"; values="toolchain-primary-public"} -Region $region
...
Write-Output ($JimmysResources.GetEnumerator() | Sort-Object -Property Name)